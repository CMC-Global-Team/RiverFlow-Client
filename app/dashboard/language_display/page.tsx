              ...
              <div className="lg:col-span-1 flex flex-col gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h1 className="text-2xl font-bold">{t("Language & Display")}</h1>
                  </div>
                  <p className="text-muted-foreground text-lg">
                    {t("Customize Your Interface Preferences")}
                  </p>
                </div>

                {/* DISPLAY INFO */}
                <div className="space-y-3">
                  <h3 className="font-semibold text-lg">{t("Display Settings")}</h3>
                  <div className="space-y-2">
                    <div className="flex gap-2 text-sm">
                      <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5 text-green-500" />
                      <span className="text-foreground">{t("Theme Applied Across All Pages")}</span>
                    </div>
                    <div className="flex gap-2 text-sm">
                      <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5 text-green-500" />
                      <span className="text-foreground">{t("Language Changes Take Effect Immediately")}</span>
                    </div>
                    <div className="flex gap-2 text-sm">
                      <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5 text-green-500" />
                      <span className="text-foreground">{t("System Theme Syncs With Device")}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-blue-500/10 border border-blue-200 dark:border-blue-900 rounded-xl">
                  <p className="text-xs text-blue-900 dark:text-blue-100 leading-relaxed">
                    <span className="font-semibold">💡 {t("Tip")}:</span> {t("Your Preferences Are Saved Automatically")}
                  </p>
                </div>
              </div>
                ...
                <div className="bg-card border border-border rounded-2xl shadow-lg p-8">
                  <div className="space-y-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <Label className="text-lg font-bold">{t("Display")}</Label>
                ...
                <div className="bg-card border border-border rounded-2xl shadow-lg p-8">
                  ...
                  <div className="space-y-6">
                        ...
                        >
                          ...
                          {currentLang.code === code && (
                            <div className="flex items-center gap-2">
                              <span className="text-xs font-medium opacity-75">{t("active")}</span>
                    ...
                    <div className="p-4 bg-muted rounded-xl border border-border">
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-foreground">{t("Active Language")}:</span>
                        <div className="flex items-center gap-2">

  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-md animate-scale-in rounded-2xl bg-card p-8 shadow-2xl">
        {/* Close Button */}
        <button onClick={onClose} className="absolute right-4 top-4 rounded-lg p-2 hover:bg-muted transition-colors">
          <X className="h-5 w-5" />
        </button>
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Create beautiful mindmaps together</p>
        </div>

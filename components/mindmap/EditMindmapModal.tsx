...
export default function EditMindmapModal({
  ...
  const { t } = useTranslation("EditMindmapModal")
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg mx-4 bg-card rounded-xl shadow-2xl border border-border animate-in zoom-in-95 slide-in-from-bottom-4 duration-300">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <h2 className="text-xl font-bold text-foreground">{t("editMindmap")}</h2>
          <button
            onClick={onClose}
            disabled={isLoading}
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder={t("enterMindmapTitle")}
              disabled={isLoading}
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={t("enterMindmapDescription")}
              disabled={isLoading}
              rows={4}
          ...
          <p className="text-xs text-muted-foreground">
            {t("press")} <kbd className="px-2 py-1 rounded bg-muted">Ctrl</kbd> +{" "}
            <kbd className="px-2 py-1 rounded bg-muted">Enter</kbd> {t("toSave")}
          </p>
        </div>

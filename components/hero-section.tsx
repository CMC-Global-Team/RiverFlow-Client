      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2">
            ...
            <span className="text-4xl md:text-2xl font-bold text-foreground leading-tight drop-shadow-lg text-balance">{t("heroSection.welcome")}</span>
          </div>

          {/* Title */}
          <h1 ref={titleRef} className="text-4xl md:text-6xl font-bold text-foreground leading-tight drop-shadow-lg text-balance">
            {t("heroSection.title.createBeautiful")}{" "}
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent drop-shadow-lg">{t("heroSection.title.mindmaps")}</span>{" "}
            {t("heroSection.title.together")}
          </h1>
          ...
          <div ref={buttonsRef} className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 ">
            ...
            >
              {t("heroSection.buttons.watchDemo")}
            </button>
          </div>
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 md:gap-12">
            <div>
              ...
              <p className="text-4xl md:text-2xl font-bold text-foreground leading-tight drop-shadow-lg text-balance">{t("heroSection.stats.activeUsers")}</p>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-primary drop-shadow-lg">50K+</div>
              <p className="text-4xl md:text-2xl font-bold text-foreground leading-tight drop-shadow-lg text-balance">{t("heroSection.stats.mindmapsCreated")}</p>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-primary drop-shadow-lg">99.9%</div>
              <p className="text-4xl md:text-2xl font-bold text-foreground leading-tight drop-shadow-lg text-balance ">{t("heroSection.stats.uptime")}</p>
            </div>
          </div>
        </div>
      </div>
